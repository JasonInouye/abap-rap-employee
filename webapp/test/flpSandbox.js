		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#EmployeeSkillAppemployeeskill-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"EmployeeSkillAppemployeeskill-display": {
								"semanticObject": "EmployeeSkillAppemployeeskill",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=EmployeeSkillApp.employeeskill",
									"url": sap.ui.require.toUrl("EmployeeSkillApp/employeeskill")
								}
							}
						}
					}
